...
export const metadata: Metadata = {
  title: 'Asian Trans Cams ❤️ Live Sex Chat on Chaturbate.Lat',
  ...
  alternates: {
    canonical: 'https://chaturbate.lat/trans/asian-cams/',
  },
};
...
export default async function AsianPage() {
  const initialModels = await fetchModels('trans', 1, 36, undefined, 'asia');
