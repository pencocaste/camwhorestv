...
export function TransEbonyDescription() {
  const isMobile = useMediaQuery('(max-width: 768px)');
  
  const description = `Experience the beauty and sensuality of our Ebony trans models on Chaturbate. Our diverse collection of Black performers brings passion, energy, and authenticity to every show. From casual chats to intimate performances, our Ebony models offer a unique and engaging experience that celebrates diversity and natural beauty.`;

  return (
    <div>
      <h1 className="text-2xl font-bold mb-1">Ebony Trans Cams</h1>
